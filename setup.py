...
kwargs = dict(
    ...
    entry_points={
        "console_scripts": [
            "hddcoin = chia.cmds.chia:main",
            "hddcoin_daemon = chia.daemon.server:main",
            "hddcoin_wallet = chia.server.start_wallet:main",
            "hddcoin_full_node = chia.server.start_full_node:main",
            "hddcoin_harvester = chia.server.start_harvester:main",
            "hddcoin_farmer = chia.server.start_farmer:main",
            "hddcoin_introducer = chia.server.start_introducer:main",
            "hddcoin_crawler = chia.seeder.start_crawler:main",
            "hddcoin_seeder = chia.seeder.dns_server:main",
            "hddcoin_timelord = chia.server.start_timelord:main",
            "hddcoin_timelord_launcher = chia.timelord.timelord_launcher:main",
            "hddcoin_full_node_simulator = chia.simulator.start_simulator:main",
        ]
    },
    package_data={
